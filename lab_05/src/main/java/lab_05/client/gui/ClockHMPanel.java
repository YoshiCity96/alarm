 ...
 */
public class ClockHMPanel extends javax.swing.JPanel {
    public int id = -1;
    ...
    public ClockHMPanel(int id, String initTime) {
        initComponents();
        this.id = id;
        time_label.setText(initTime);
    }
       
    public ClockHMPanel(int id) {
        initComponents();
        this.id = id;
    }
    ...
    private void initComponents() {
        ...
        add(h_cb, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 51, -1));
        ...
        add(m_cb, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 80, 50, -1));
        ...
        add(delete_alarm_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 190, 262, -1));
        ...
        add(h_cb1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 51, -1));
        ...
        add(m_cb1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, 50, -1));
    ...
    private void alarm_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alarm_btnActionPerformed
        GUI_Controller.event(2, id, getH(), getM(), 0);
